Pod::Spec.new do |spec|
  ...
  spec.source             = { :git => "https://github.com/loopindustries/ALCameraViewController.git", :tag => spec.version.to_s }
  ...
  spec.homepage           = "https://github.com/loopindustries/ALCameraViewController"
